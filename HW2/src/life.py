...
class Life:
    ...
    def step(self) -> None:
        ...
        # these cells.
        # print(neighbors)
        # self._nbr_count[neighbors[0]] = 2
        # print(self._nbr_count.table)
        # print(self._nbr_count.items())
        # print(f' nnene {self._nbr_count.get(neighbors[0])}')
        # # print('test '+ self._nbr_count[neighbors[0]])
        # print('wtf')
